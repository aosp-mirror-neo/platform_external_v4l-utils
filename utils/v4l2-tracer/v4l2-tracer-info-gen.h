...
constexpr flag_def v4l2_hevc_ext_sps_st_rps_flag_def[] = {
	{ V4L2_HEVC_EXT_SPS_ST_RPS_FLAG_INTER_REF_PIC_SET_PRED, "V4L2_HEVC_EXT_SPS_ST_RPS_FLAG_INTER_REF_PIC_SET_PRED" },
	{ 0, "" }
};

constexpr flag_def v4l2_hevc_ext_sps_lt_rps_flag_def[] = {
	{ V4L2_HEVC_EXT_SPS_LT_RPS_FLAG_USED_LT, "V4L2_HEVC_EXT_SPS_LT_RPS_FLAG_USED_LT" },
	{ 0, "" }
};
...
constexpr val_def v4l2_ctrl_type_val_def[] = {
	...
	{ V4L2_CTRL_TYPE_HEVC_EXT_SPS_ST_RPS,	"V4L2_CTRL_TYPE_HEVC_EXT_SPS_ST_RPS" },
	{ V4L2_CTRL_TYPE_HEVC_EXT_SPS_LT_RPS,	"V4L2_CTRL_TYPE_HEVC_EXT_SPS_LT_RPS" },
...
constexpr val_def control_val_def[] = {
	...
	{ V4L2_CID_MPEG_VIDEO_BACKGROUND_DETECTION,	"V4L2_CID_MPEG_VIDEO_BACKGROUND_DETECTION" },
	...
	{ V4L2_CID_FLASH_DURATION,	"V4L2_CID_FLASH_DURATION" },
	{ V4L2_CID_FLASH_STROBE_OE,	"V4L2_CID_FLASH_STROBE_OE" },
	...
	{ V4L2_CID_STATELESS_HEVC_EXT_SPS_ST_RPS,	"V4L2_CID_STATELESS_HEVC_EXT_SPS_ST_RPS" },
	{ V4L2_CID_STATELESS_HEVC_EXT_SPS_LT_RPS,	"V4L2_CID_STATELESS_HEVC_EXT_SPS_LT_RPS" },
